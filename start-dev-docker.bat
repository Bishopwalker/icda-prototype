@echo off
REM ICDA Docker Development Server
REM Starts Docker services (Redis, OpenSearch), FastAPI backend and Vite frontend

echo ============================================================
echo    ICDA Prototype - Docker Development Server
echo ============================================================
echo.
